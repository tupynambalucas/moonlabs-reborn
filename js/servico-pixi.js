...
let app = new PIXI.Application({backgroundAlpha: true, width: width, height: height});
...
for (let i = 0; i < totalDudes; i++) {
    ...
    var prometheus = PIXI.Texture.from('../img/sprites/prometheus.png');
    var puppeteer = PIXI.Texture.from('../img/sprites/puppeteer.png');
    var react = PIXI.Texture.from('../img/sprites/react.png');
    var terraform = PIXI.Texture.from('../img/sprites/terraform.png');
    var threejs = PIXI.Texture.from('../img/sprites/threejs.png');
    var vue = PIXI.Texture.from('../img/sprites/vue.png');
    var zabbix = PIXI.Texture.from('../img/sprites/zabbix.png');
    const spritesArray = new Array(cloud,docker,electron,express,grafana,kubernetes,linux,mongo,prometheus,puppeteer,react,terraform,threejs,vue,zabbix)
    ...
    dude.scale.set(0.15 + Math.random() * 0.2);
